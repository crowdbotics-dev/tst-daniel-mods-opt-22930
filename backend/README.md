...
## Project Structure
    ...
    ├── tst_daniel_mods_opt_22930  # Django project configurations
...
1. Clone this repo and `cd tst_daniel_mods_opt_22930`
...
2. Clone this repo and `cd tst_daniel_mods_opt_22930`
